...
##                             VERIFY GO VERSION                              ##
################################################################################
# Go 1.14+ required for Go modules.
GO_VERSION_EXP := "go1.14"
...
##                                   DIST                                     ##
################################################################################
DIST_CSI_NAME := vcloud-csi-$(VERSION)
...
clean:
	@rm -f Dockerfile*
	rm -f $(CSI_BIN) vcloud-csi-*.tar.gz vcloud-csi-*.zip \
